function alpha_rev=calibration_alpha_global_zcb(ttm,ytm,UFR,alpha_0,T2,tol_converge,display_option,Umat,n_peryear)
...
[~,~,fr_vector,~,~]=smith_wilson_zcb(ttm,ytm,UFR,alpha_rev,Umat,n_peryear);
